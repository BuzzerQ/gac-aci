        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="formsExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="<?= base_url('investor/investor/') ?>">
              ...
              <div class="col-md-12">
                <div class="card ">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <h4 class="card-title">Pensiun Dini Sejahtera</h4>
                  </div>
                  <div class="card-body ">
                    <div class="row">
                      <div class="col-md-6">
                          ...
                          <table class="table">
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="<?= base_url(); ?>assets/img/flags/new_logo.png" </div>
                                </td>
                                <td>Investor</td>
                                <td class="text-right">
                                  2.920
...
7 days
                          ...
                          <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                              <div class="card-header card-header-success card-header-icon">
                                ...
                                <p class="card-category">Penerimaan Pembayaran</p>
                        ...
                        <h3>Program Pensiun Dini Sejahtera</h3>
                        <br>
                        <div class="row">
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="<?= base_url(); ?>/assets/img/info/image-5.12.jpeg">
                                </a>
                              </div>
                              <div class="card-body">
                          ...
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="<?= base_url(); ?>/assets/img/info/image-umroh.jpeg">
                                </a>
                              </div>
                              <div class="card-body">
                                <div class="card-actions text-center">
