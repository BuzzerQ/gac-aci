...
if (flashData == 'masuk') {
  swal({
    ...
    text: "Di System Gemesin Asia Charts",
...
} else if (flashData == 'datasudahada') {
  swal({
    title: "Ooops!",
    text: "Nik KTP Anda Sudah Terdaftar Silahkan Lakukan Pembayaran Untuk Menyelesaikan Pendaftaran",
    buttonsStyling: false,
    confirmButtonClass: "btn btn-danger",
    type: "error"
  }).catch(swal.noop)
...
} else if (flashData == 'tambahCoach') {
  swal({
    title: "Terimakasih!",
    text: "Coach, Berhasil Ditambahkan.",
    buttonsStyling: false,
    confirmButtonClass: "btn btn-success",
    type: "success"
  }).catch(swal.noop)
...
} else if (flashData == 'daftarsucces') {
  swal({
    title: "Terimakasih!",
    text: "Pendaftaran Anda Telah Berhasil Silahkan Check Email anda untuk menggetahui Id & Password Login anda.",
    buttonsStyling: false,
    confirmButtonClass: "btn btn-success",
    type: "success"
  }).catch(swal.noop)
...
}else if (flashData == 'idCoach') {
  swal({
    title: "ID Coach Anda Tidak Ditemukan.!",
    text: "Silahkan Coba Lagi Atau Hubungi Coach Anda.",
    buttonsStyling: false,
    confirmButtonClass: "btn btn-danger",
    type: "error"
  }).catch(swal.noop)
}else if (flashData == 'setujuigth') {
  swal({
    title: "Terimakasih!",
    text: "Ganti Hari ini telah disetujui.",
    buttonsStyling: false,
    confirmButtonClass: "btn btn-success",
    type: "success"
  }).catch(swal.noop)
